 ...
 * @author weiyangjun
 */
public class GetFuelCardParams {
    /**
     * 主卡号
     */
    ...
    public GetFuelCardParams(String masterCardNumber, String viceCardNumber, String cardMerchant, String bundlePlateNumber, String city, String ifBundle, Integer start, Integer length) {
        this.masterCardNumber = masterCardNumber;
        this.viceCardNumber = viceCardNumber;
        this.cardMerchant = cardMerchant;
        this.bundlePlateNumber = bundlePlateNumber;
