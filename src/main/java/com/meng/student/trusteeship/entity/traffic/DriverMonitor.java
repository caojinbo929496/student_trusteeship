...
/**
 * @Author: 吴宸煊
 * @Description: 司机违章实体类（与页面交互）
 * @Date: Created in 14:48 2018/3/19
 */
public class DriverMonitor implements Serializable {
    ...
    public DriverMonitor(DriverMonitorPO driverMonitorPO) {
        this.setDeductMark(driverMonitorPO.getDeductMark());
        this.setName(driverMonitorPO.getName());
        this.setPenalty(driverMonitorPO.getPenalty());
        this.setUnTreated(driverMonitorPO.getUnTreated());
        this.setWarehouse(driverMonitorPO.getWarehouse());
    }
