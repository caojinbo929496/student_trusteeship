...
public class CarAllInfo implements Serializable {
     ...
     * 车辆年审状态
     */
    private String vehicleValidityStatus;
    ...
    public String getVehicleValidityStatus() {
        return vehicleValidityStatus;
    }

    public void setVehicleValidityStatus(String vehicleValidityStatus) {
        this.vehicleValidityStatus = vehicleValidityStatus;
    }
