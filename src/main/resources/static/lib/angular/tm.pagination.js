...
angular.module('tm.pagination', []).directive('tmPagination', [function () {
    return {
        ...
        template: '<div class="page-list clearfix">' +
            ...
            '跳转至<input type="text" ng-model="jumpPageNum" ng-keyup="jumpPageKeyUp($event)"/>' + '页<a href="javascript:void(0);" class="confirm-button" ng-click="jumpPageKeyUp($event)">确认</a>' +
            '</div>' +
