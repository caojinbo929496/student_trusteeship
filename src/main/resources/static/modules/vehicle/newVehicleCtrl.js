...
scriptApp.controller('newVehicleCtrl', function ($scope, $http) {
    ...
    table.render({
        ...
        , cols: [[
            ...
            , {field: 'warehouse', title: '所属仓库', align: 'center'}
            , {field: 'brandModelNumber', title: '车辆品牌', align: 'center'}
            , {field: 'vehicleType', title: '车辆分类', align: 'center'}
            , {
